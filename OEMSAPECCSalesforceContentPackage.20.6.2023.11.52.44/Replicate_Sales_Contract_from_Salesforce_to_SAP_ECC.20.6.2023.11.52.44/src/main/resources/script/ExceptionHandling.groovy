        ...
        def Message processData(Message message) {
                        ...
                        {
                            errordetails = "The Service Contract replication failed because of the following error:  " + ex.toString()
                            attachID  = "Error Details for Service Contract"
                        }
                        else 
                        {
                            errordetails = "The Service Contract replication of  '" + refernceID + "' failed because of the following error:  " + ex.toString()
                            attachID  = "Error Details for Service Contract '" + refernceID + "'"	
                        }
