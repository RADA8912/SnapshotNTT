...
/**
 * Gets a date in ISO 8601 (yyyy-MM-dd) from JSON format in milli seconds or  with date labeling (/Date(...)/).
 * First argument is date in milli seconds or  with date labeling (/Date(...)/).
