...
def Message processData(Message message) {
	...
	logger.addEntry("customInterfaceDetermination", "Partner ID to read the custom interface determination: " + Pid?:"n/a")
	logger.addEntry("customInterfaceDetermination", "Custom interface determination end point from the Partner Directory: property CustomXIDEndpoint=" + message.properties.CustomXRDEndpoint.toString()?:"n/a")
	logger.addEntry("customInterfaceDetermination", "Custom interface determination existence from the Partner Directory: property customXIDBoolean=" + message.properties.customXRDBoolean.toString()?:"n/a")
