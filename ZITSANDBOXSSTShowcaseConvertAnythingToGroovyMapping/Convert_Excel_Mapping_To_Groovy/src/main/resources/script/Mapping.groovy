	...
	if (message.getBodySize() > 0) {
		...
		xml.Materials {
			...
			Material {
				...
				// Map Rule: 1:1
				'MaterialNumber' MATMAS06.IDOC.E1MARAM.MATNR.text()
				// Material Name -> XPath: /Materials/Material/MaterialName
				// Map Rule: 1:1
				'MaterialName' MATMAS06.IDOC.E1MARAM.E1MAKTM.MAKTX.text().toLowerCase()
				...
				// Map Rule: 1:1
				'UnitOfMeasure' mapWithDefault(MATMAS06.IDOC.E1MARAM.MEINS.text(), 'KGM')
				// Gross weight -> XPath: /Materials/Material/GrossWeight
				// Map Rule: 1:1
				'GrossWeight' removeAlgebraicSign(MATMAS06.IDOC.E1MARAM.BRGEW.text())
				// Net weight -> XPath: /Materials/Material/NetWeight
				// Map Rule: computed
				'NetWeight' replaceSpecialCharacters(MATMAS06.IDOC.E1MARAM.NTGEW.text())
				// Material Text -> XPath: /Materials/Material/Text
				// Map Rule: constant
				Text {
					// Material Text Line -> XPath: /Materials/Material/Text/TextLine
					// Map Rule: Check if it's the first Sunday of a year that can be divided by 2 and a half. If yes, delete the leading zeros.
					'TextLine' '' // TODO: Create mapping formula.
				}
			}
		}
