...
*							getExchangeProperty(), getDateFormat(), getHeader(), getMondayOfWeek(), getOnlyNumbers(), getValueByCondition(), headString(), isNumber(), minusFromBeginToEnd(),
*							minusFromEndToBegin(), removeAlgebraicSign(), removeAlgebraicSignPlus(), removeAllCharacters(), removeAllSpaces(), removeAllSpecialCharacters(),
...
*/
	...
	// Debug mode
	def debugModeIn = getExchangeProperty(message, "ConvertMap.DebugMode", false)
	if (debugModeIn) {
	...
	def createOnlyDebugIn = getExchangeProperty(message, "ConvertMap.CreateOnlyDebug", false)
	...
	def createTargetDescriptionIn = getExchangeProperty(message, "ConvertMap.CreateTargetDescription", false)
	...
	def createTargetXpathIn = getExchangeProperty(message, "ConvertMap.CreateTargetXpath", false)
	...
	def createMapRuleIn = getExchangeProperty(message, "ConvertMap.CreateMapRule", false)
	if (createMapRuleIn) {
	...
	def createNoConvertableFormulaIn = getExchangeProperty(message, "ConvertMap.CreateNoConvertableFormula", false)
	...
	def createSegmentHierarchyIn = getExchangeProperty(message, "ConvertMap.CreateSegmentHierarchy", false)
	...
	def createRootTargetNamespace1In = getExchangeProperty(message, "ConvertMap.CreateRootTargetNamespace1", false)
	...
	def createNodesTargetNamespace1In = getExchangeProperty(message, "ConvertMap.CreateNodesTargetNamespace1", false)
	...
	def targetNamespacePrefix1 = getExchangeProperty(message, "ConvertMap.TargetNamespacePrefix1", false)
	...
	// Target Namespace 1
	def targetNamespace1 = getExchangeProperty(message, "ConvertMap.TargetNamespace1", false)
	if (!targetNamespace1) {
	...
	def appendAllGroovyCostumFunctionsIn = getExchangeProperty(message, "ConvertMap.AppendAllGroovyCostumFunctions", false)
	...
	def appendMappingExamplesIn = getExchangeProperty(message, "ConvertMap.AppendMappingExamples", false)
			...
			if (lineLength > 0) {
				...
				if (line.indexOf('Message2') > -1) {
					...
					if (sourceLength == 0 || 'const(value=)'.equals(sourceNode)) {
						sourceNode = getEmptyConstant(sourceNode)
						sourceType = 'constant'
...
*/
		...
		if (createOnlyDebug == false) {
			...
			if (appendAllGroovyCostumFunctions == true || methodGetMondayOfWeek == true) {
				...
				sb.append(tabs + '	Locale locale = new Locale(LOCALE_LANGUAGE, LOCALE_COUNTRY)' + LINE_BREAK)
