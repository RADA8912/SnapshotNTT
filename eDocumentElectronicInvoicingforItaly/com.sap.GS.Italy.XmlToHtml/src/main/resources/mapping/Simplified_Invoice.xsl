<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:a="http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.0">
							...
							<xsl:if test="a:FatturaElettronicaSemplificata/FatturaElettronicaHeader">
								<div class="page">
									<div class="versione">										Versione 
										<xsl:value-of select="a:FatturaElettronicaSemplificata/@versione"/>
									</div>
														...
														<ul>
															<xsl:if test="DatiGenerali/DatiGeneraliDocumento/TipoDocumento">
																<li>																Tipologia documento:																
																	...
																	<xsl:choose>
																		<xsl:when test="$TD='TD07'">																		(fattura semplificata)																	</xsl:when>
																		<xsl:when test="$TD='TD08'">																		(nota di credito semplificata)																	</xsl:when>
																		<xsl:when test="$TD='TD09'">																		(nota di debito semplificata)																	</xsl:when>
													...
													<ul>
														<xsl:for-each select="DatiBeniServizi">
															<xsl:if test="Descrizione">
																<li>
																	<xsl:if test="Descrizione">																																					Descrizione bene/servizio:																			
																		<span>
															...
															<xsl:if test="DatiIVA/Imposta">
																<xsl:if test="DatiIVA/Imposta">
																	<li>																			Ammontare imposta bene/servizio:																			
																		<span>
															...
															<xsl:if test="RiferimentoNormativo">
																<xsl:if test="RiferimentoNormativo">
																	<li>																			Riferimento normativo bene/servizio:																			
																		<span>
