											...
											<ul>
												<xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/DatiTrasmissione">
													...
													<xsl:if test="CodiceDestinatario">
														<li>															Codice identificativo destinatario:															
															<span>
														...
														<xsl:if test="DatiGenerali/DatiGeneraliDocumento/TipoDocumento">
															<li>																Tipologia documento:																
																...
																<xsl:choose>
																	...
																	<xsl:when test="$TD='TD24'">																		(fattura differita - art.21 c.4 lett. a)																	</xsl:when>
																	<xsl:when test="$TD='TD25'">																		(fattura differita - art.21 c.4 terzo periodo lett. b)																	</xsl:when>
																	...
																	<xsl:if test="Natura">
																		<li>																			Tipologia di non imponibilità del contributo:																			
																			...
																			<xsl:choose>
																				...
																				<xsl:when test="$NT='N6.2'">																					(inversione contabile - cessione di oro e 																					argento puro)																				</xsl:when>
															...
															<xsl:if test="Natura">
																<li>																	Natura operazione:																	
																	...
																	<xsl:choose>
																		...
																		<xsl:when test="$NAT='N6.2'">																			(inversione contabile - cessione di oro e 																			argento puro)																		</xsl:when>
															...
															<xsl:if test="Natura">
																<li>																	Natura operazioni:																	
																	...
																	<xsl:choose>
																		...
																		<xsl:when test="$NAT1='N6.2'">																			(inversione contabile - cessione di oro e 																			argento puro)																		</xsl:when>
