...
def Message processData(Message message) {
				...
				{
					errordetails = "The Sales Pricing replication failed because of the following error:  " + ex.toString()
					attachID  = "Error Details for Sales Pricing"
				}
				else 
				{
					errordetails = "The Sales Pricing replication of  '" + refernceID + "' failed because of the following error:  " + ex.toString()
					attachID  = "Error Details for Sales Pricing '" + refernceID + "'"	
				}
