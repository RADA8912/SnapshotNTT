...
def Message processData(Message message) {
    ...
    attributePayload  += processClassificationAttribute( chr ,cls_catalog_type);
  }
  
  message.setBody(XmlUtil.serialize('<batchParts>'+attributePayload+ '</batchParts>'));
  return message;
}
              ...
              ClassificationAttribute{
                ...
                localizedAttributes{
                    batchAttributeLangList.each {key,value->
                        LocalizedClassificationAttribute{
