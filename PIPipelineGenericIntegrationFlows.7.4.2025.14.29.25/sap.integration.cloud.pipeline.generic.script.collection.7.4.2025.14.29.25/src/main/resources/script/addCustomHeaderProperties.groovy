...
def Message processData(Message message) {
	...
	def logEntry = new StringBuilder().append("Current retry run: header SAPJMSRetries=").append(message.headers.SAPJMSRetries.toString() ?: "n/a").toString();
	logger.addEntry("addCustomHeaderProperties", logEntry);
	logEntry = new StringBuilder().append("List of custom header properties: header customHeaderProperties=").append(message.headers.customHeaderProperties.toString() ?: "n/a").toString();
    logger.addEntry("addCustomHeaderProperties", logEntry);
