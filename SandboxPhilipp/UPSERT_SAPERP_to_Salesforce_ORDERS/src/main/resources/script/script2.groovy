...
def Message processData(Message message) {
                ...
                {
                    errordetails = "The Account replication failed because of the following error:  " + ex.toString()
                    attachID  = "Error Details for Account"
                }
                else 
                {
                    errordetails = "The Account replication of  '" + refernceID + "' failed because of the following error:  " + ex.toString()
                    attachID  = "Error Details for Account '" + refernceID + "'"	
                }
