...
import de.itelligence.mappings.mf.ItelliMappingEdeka_EdifactOrders01B_to_OrdersITXCombined
...
def Message processData(Message message) {
    ...
    try{
        ...
        new ItelliMappingEdeka_EdifactOrders01B_to_OrdersITXCombined().performMapping(bodyAsInputStream, baos,false);
