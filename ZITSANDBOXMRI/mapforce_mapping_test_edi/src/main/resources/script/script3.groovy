...
import de.itelligence.mappings.mf.ItelliMappingIdocOrdersGen_to_IDocOrders05Combined
...
def Message processData(Message message) {
    ...
    try{
        ...
        new ItelliMappingIdocOrdersGen_to_IDocOrders05Combined().performMapping(bodyAsInputStream, baos,false);
