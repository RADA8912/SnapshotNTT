...
import de.itelligence.mappings.mf.ItelliMappingEdeka_InvoicITX_to_EdifactInvoic01BCombined
...
def Message processData(Message message) {
    ...
    try{
        ...
        new ItelliMappingEdeka_InvoicITX_to_EdifactInvoic01BCombined().performMapping(bodyAsInputStream, baos,false);
