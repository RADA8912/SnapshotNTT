...
import de.itelligence.mappings.mf.ItelliMappingIDocInvoicGen_to_InvoicITXCombined
...
def Message processData(Message message) {
    ...
    try{
        ...
        new ItelliMappingIDocInvoicGen_to_InvoicITXCombined().performMapping(bodyAsInputStream, baos, false);
