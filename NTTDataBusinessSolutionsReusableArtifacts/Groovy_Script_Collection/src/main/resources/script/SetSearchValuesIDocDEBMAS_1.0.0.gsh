...
def Message processData(Message message) {
	if (message.getBodySize() > 0) {
		...
		String name1 = root.IDOC.E1KNA1M.NAME1[0].text() // DEBMAS0x
		String name2 = root.IDOC.E1KNA1M.NAME2[0].text() // DEBMAS0x
