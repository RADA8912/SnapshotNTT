...
/**
* SetSearchValuesIDocBUPA
* Set IDoc fields to header fields and log entries for search by IDoc number in message monitor.
* 'Business Partner Number (BPARTNER)', 'Business Partner GUID (BPARTNERGUID)', 'Name 1 (NAME1)', 'Name 2 (NAME2)' are supported.
...
def Message processData(Message message) {
	if (message.getBodySize() > 0) {
		...
		String name1 = root.IDOC.E101BUS_EI_EXTERN.E101BUS_EI_CENTRAL_DATA.E101BUS_EI_BUPA_CENTRAL.E101US_EI_BUPA_CENTRAL_DATA.E101_EI_STRUC_CENTRAL_ORGAN.NAME1[0].text() // BUPA_INBOUND_MAIN_SAVE_M0x
		String name2 = root.IDOC.E101BUS_EI_EXTERN.E101BUS_EI_CENTRAL_DATA.E101BUS_EI_BUPA_CENTRAL.E101US_EI_BUPA_CENTRAL_DATA.E101_EI_STRUC_CENTRAL_ORGAN.NAME2[0].text() // BUPA_INBOUND_MAIN_SAVE_M0x
