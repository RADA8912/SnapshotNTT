...
def Message processData(Message message) {
				...
				{
					errordetails = "The Supplier replication failed because of the following error:  " + ex.toString()
					attachID  = "Error Details for Supplier"
				}
				else 
				{
					errordetails = "The Supplier replication  '" + refernceID + "' failed because of the following error:  " + ex.toString()
					attachID  = "Error Details for Supplier'" + refernceID + "'"	
				}
