...
def Message processData(Message message)
{
	...
	messageLog.addCustomHeaderProperty("ConvertCharset.ReplacementChar", replacementChar.toString())

	sourceEncoding = getExchangeProperty(message, "ConvertCharset.SourceEncoding", true)
	messageLog.addCustomHeaderProperty("ConvertCharset.SourceEncoding", sourceEncoding.toString())

	targetEncoding = getExchangeProperty(message, "ConvertCharset.TargetEncoding", true)
	messageLog.addCustomHeaderProperty("ConvertCharset.TargetEncoding", targetEncoding.toString())
